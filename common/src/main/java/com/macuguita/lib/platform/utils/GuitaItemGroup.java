...
public class GuitaItemGroup {
    ...
    public final List<GuitaRegistry<ItemConvertible>> registries = new ArrayList<>();
    @Deprecated
    @ApiStatus.ScheduledForRemoval(inVersion = "1.21")
    ...
    public Supplier<ItemGroup> build() {
        return create(this);
    }

    @ExpectPlatform
    private static Supplier<ItemGroup> create(GuitaItemGroup tab) {
